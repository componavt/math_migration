...
pogr1=abs(x0[0]-xfact[0])#error in 1 point
pogr2=abs(x0[1]-xfact[1])#error in 1 point
pogr3=abs(x0[2]-xfact[2] )#error in 2 point

pogr4=abs(x0[3]-xfact[3])#error in 2 point
pogr5=abs(x0[4]-xfact[4] )#error in 3 point
pogr6=abs(x0[5]-xfact[5] )#error in 3 point

pogr7=abs(x0[6]-xfact[6] )#error in 4 point
pogr8=abs(x0[7]-xfact[7] )#error in 4 point
pogr9=abs(x0[8]-xfact[8] )#error in 5 point

pogr10=abs(x0[9]-xfact[9])#error in 5 point



vectpogr1=[pogr1,pogr2,pogr3,pogr4,pogr5]
totalpogr1=ln.norm(vectpogr1)
totalpogrlist1=[totalpogr1]

vectpogr2=[pogr6,pogr7,pogr8,pogr9,pogr10]
totalpogr2=ln.norm(vectpogr2)
...
while(norma>=eps1):
    ...
    beta2=s0[3]
    ilist.append(i)
    totalpogrlist1.append(totalpogr1)
    totalpogrlist2.append(totalpogr2)
...
for s0 in slist:#solution of ODE1 on i step with new parameters a0
     ...
     fig1.append(plt.plot(thlist,x01list1,"go",lw=0.07))#for plot of 1 region
     fig1.append(plt.plot(thlist,x01list2,"yo",lw=0.07))#for plot of 2 region

             

plt.xlabel('t')
plt.ylabel('u')
plt.legend(['initial value 1','u1(t)', 'initial value 2','u2(t)' ], loc = 'upper right')              
plt.grid(fig1)
plt.show(fig1)
...
for i in ilist:
   plt.plot(i,totalpogrlist1[i],"ko",lw=0.07)
   plt.plot(i,totalpogrlist2[i],"ro",lw=0.07)
   
   fig2.append(plt.plot(i, totalpogrlist1[i],"ko",lw=0.07))
   fig2.append(plt.plot(i,totalpogrlist2[i],"ro", lw=0.07))



plt.xlabel('i')
plt.ylabel('totalpogr_i, i=1,2')
plt.legend(['total error'], loc = 'upper right')              
plt.grid(fig2)
plt.show(fig2)
