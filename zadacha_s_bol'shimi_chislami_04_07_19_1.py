...
u0=np.array([105139101.,37694401.])#initial value of population in 1 and 2 region respectively
u1= np.array([105242686.,37623747.])#numer of population, time 1
u2= np.array([105386177.,37670206.])#numer of population, time 2
u3= np.array([105619818.,37727241.])#numer of population, time 3
u4= np.array([105913327.,37753604.])#numer of population, time 4
u5= np.array([106173357.,37799043.])#numer of population, time 5 
...
class IVPOPTIM(object):  #Problems that are solved by the Runge-Kutta method
     def __init__(self, f=None,u0=np.array([105139101.,37694401.]) , t0=0., T=6.0, dt0=0.01, exact=None, desc='', name='',dt=0.01):
        self.u0  = u0
        self.rhs = f
        self.T   = T
        self.exact = exact
