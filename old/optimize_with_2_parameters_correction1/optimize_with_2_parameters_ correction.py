...
aa1=((a[0]/u0)+(a[1]/u1)+(a[2]/u2))/3.0 #average coefficient of population, who arrives to region 1



#aa2=((a[1]/u0[1])+(a[3]/u1[1])+(a[5]/u2[1]))/3.0#average coefficient  of population, who arrives to region 2
print('Average coefficient of population, who arrives to region 1 is', round(aa1,4) )

al1=((l[0]/u0)+(l[1]/u1)+(l[2]/u2))/3.0 #average coefficient of population, who leaves region 1
al11=Decimal(al1).quantize(TWOPLACES)
al12=al11
#al2=((l[1]/u0[1])+(l[3]/u1[1])+(l[5]/u2[1]))/3.0#average coefficient of population, who leaves region 2
print('Average coefficient of population, who leaves region 1 is', round(al1,4))
...
#norma1=(((gradv[0])**2)+((gradv[1])**2))**0.5
#print(norma1)
if (norma<=eps1):
        s0=s0  
