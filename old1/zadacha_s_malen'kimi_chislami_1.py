...
u5= np.array([106.173357,37.799043])#numer of population, time 5 0.001 0.022 0.005 0.002
...
r4=4*r1
r5=5*r1
u6=np.array([u[0],u[r1],u[r2],u[r3],u[r4],u[r5]])#approximate soluton in moment of time 1,2,3,4,5

ivp=detest('2OD1')
myivp=ivp#load initial parameters from problem
t,u = rk44(myivp)#approximate soluton of problem
u7=np.array([u[0],u[r1], u[r2], u[r3],u[r4], u[r5]])


ivp=detest('2OD2')
myivp=ivp  #load initial parameters from problem
t,u = rk44(myivp)#approximate soluton of problem
u8=np.array([u[0],u[r1], u[r2], u[r3],u[r4], u[r5]])

ivp=detest('2OD3')
myivp=ivp#load initial parameters from problem
t,u = rk44(myivp)#approximate soluton of problem
u9=np.array([u[0],u[r1], u[r2], u[r3],u[r4], u[r5]])

ivp=detest('2OD4')
myivp=ivp#load initial parameters from problem
t,u = rk44(myivp)#approximate soluton of problem
u40=np.array([u[0],u[r1], u[r2], u[r3],u[r4], u[r5]])

x0=np.array([u6[0][0],u6[1][0],u6[2][0],u6[3][0],u6[4][0],u6[5][0],u6[0][1],u6[1][1],u6[2][1],u6[3][1],u6[4][1],u6[5][1]])#array of solution in moment of time 1,2,3
xfact=np.array([u0[0],u1[0],u2[0],u3[0],u4[0],u5[0],u0[1],u1[1],u2[1],u3[1],u4[1],u5[1]])#fact values in moment of time 1,2,3
x1=np.array([u7[0][0],u7[1][0],u7[2][0],u7[3][0],u7[4][0],u7[5][0],u7[0][1],u7[1][1],u7[2][1],u7[3][1],u7[4][1],u7[5][1]])#solutions with with the first parameter changed by an amount dq 
x2=np.array([u8[0][0],u8[1][0],u8[2][0],u8[3][0],u8[4][0],u8[5][0],u8[0][1],u8[1][1],u8[2][1],u8[3][1],u8[4][1],u8[5][1]])#solutions with with the second parameter changed by an amount dq
x3=np.array([u9[0][0],u9[1][0],u9[2][0],u9[3][0],u9[4][0],u9[5][0],u9[0][1],u9[1][1],u9[2][1],u9[3][1],u9[4][1],u9[5][1]])#solutions with with the third parameter changed by an amount dq
x4=np.array([u40[0][0],u40[1][0],u40[2][0],u40[3][0],u40[4][0],u40[5][0], u40[0][1],u40[1][1],u40[2][1],u40[3][1],u40[4][1],u40[5][1]])#solutions with with the 4 parameter changed by an amount dq


x01list1=([u6[0][0],u6[1][0],u6[2][0],u6[3][0],u6[4][0],u6[5][0]])
x01list2=([u6[0][1],u6[1][1],u6[2][1],u6[3][1],u6[4][1],u6[5][1]])

func=delta1*sum((xfact[0:6]-x0[0:6])**2)+delta2*sum((xfact[6:]-x0[6:])**2)#function which must be minimized
...
v1=np.array([((x1[0]-x0[0])/dq), ((x1[1]-x0[1])/dq),((x1[2]-x0[2])/dq), ((x1[3]-x0[3])/dq),((x1[4]-x0[4])/dq),
             ((x1[5]-x0[5])/dq),((x1[6]-x0[6])/dq), ((x1[7]-x0[7])/dq),((x1[8]-x0[8])/dq), ((x1[9]-x0[9])/dq),((x1[10]-x0[10])/dq), ((x1[11]-x0[1])/dq) ])#derivative with the first parameter
v2=np.array([((x2[0]-x0[0])/dq), ((x2[1]-x0[1])/dq),((x2[2]-x0[2])/dq), ((x2[3]-x0[3])/dq),((x2[4]-x0[4])/dq), ((x2[5]-x0[5])/dq),
             ((x2[6]-x0[6])/dq), ((x2[7]-x0[7])/dq),((x2[8]-x0[8])/dq), ((x2[9]-x0[9])/dq), ((x2[10]-x0[10])/dq), ((x2[11]-x0[1])/dq)])#derivative with the second parameter
v3=np.array([((x3[0]-x0[0])/dq), ((x3[1]-x0[1])/dq),((x3[2]-x0[2])/dq), ((x3[3]-x0[3])/dq),((x3[4]-x0[4])/dq),
             ((x3[5]-x0[5])/dq),((x3[6]-x0[6])/dq), ((x3[7]-x0[7])/dq),((x3[8]-x0[8])/dq),((x3[9]-x0[9])/dq), ((x3[10]-x0[10])/dq), ((x3[11]-x0[1])/dq) ])#derivative with the third parameter

v4= np.array([((x4[0]-x0[0])/dq), ((x4[1]-x0[1])/dq),((x4[2]-x0[2])/dq), ((x4[3]-x0[3])/dq),((x4[4]-x0[4])/dq), ((x4[5]-x0[5])/dq),((x4[6]-x0[6])/dq),
              ((x4[7]-x0[7])/dq),((x4[8]-x0[8])/dq), ((x4[9]-x0[9])/dq),((x4[10]-x0[10])/dq), ((x4[11]-x0[1])/dq)])#derivative with the 4 parameter


derv1 = -2*delta1*sum((xfact[0:6]-x0[0:6])*(v1[0:6]))-2*delta2*sum((xfact[6:]-x0[6:])*(v1[6:]))#derivative of function with the first parameter
derv2 = -2*delta1*sum((xfact[0:6]-x0[0:6])*(v2[0:6]))-2*delta2*sum((xfact[6:]-x0[6:])*(v2[6:]))#derivative of function with the second parameter
derv3 = -2*delta1*sum((xfact[0:6]-x0[0:6])*(v3[0:6]))-2*delta2*sum((xfact[6:]-x0[6:])*(v3[6:]))#derivative of function with the third parameter
derv4 = -2*delta1*sum((xfact[0:6]-x0[0:6])*(v4[0:6]))-2*delta2*sum((xfact[6:]-x0[6:])*(v4[6:]))#derivative of function with the 4 parameter
...
fig1=[plt.plot(thlist,ulist1,"r-", lw=0.5), plt.plot(thlist,x01list1,"g-", lw=0.1),plt.plot(thlist,ulist2,"b-",lw=0.5), plt.plot(thlist,x01list2,"y-",lw=0.1)]
#fig2=[plt.plot(thlist,ulist2,"b-",marker='o',lw=0.1), plt.plot(thlist,x01list2,"y-",marker='o',lw=0.1) ]#for plot of 1, 2 region
...
while(norma>=eps1):
    ...
    myivp=ivp#load initial parameters from problem
    t,u = rk44(myivp)#approximate soluton of problem    
    u11=np.array([u[0],u[r1], u[r2], u[r3],u[r4], u[r5]])
    ...
    u12=np.array([u[0],u[r1], u[r2], u[r3],u[r4], u[r5]])
    ...
    u13=np.array([u[0],u[r1], u[r2], u[r3],u[r4], u[r5]])        
  
    ivp=detest('2OD14')
    myivp=ivp#load initial parameters from problem
    t,u = rk44(myivp)#approximate soluton of problem    
    
    u14=np.array([u[0],u[r1], u[r2], u[r3],u[r4], u[r5]])
    ...
    u22=np.array([u[0],u[r1], u[r2], u[r3],u[r4], u[r5]])
    
    ivp=detest('2OD23')
    myivp=ivp#load initial parameters from problem
    t,u = rk44(myivp)#approximate soluton of problem    
    
    u23=np.array([u[0],u[r1], u[r2], u[r3],u[r4], u[r5]])

    ivp=detest('2OD24')
    myivp=ivp#load initial parameters from problem
    t,u = rk44(myivp)#approximate soluton of problem     
    u24=np.array([u[0],u[r1], u[r2], u[r3],u[r4], u[r5]])

    ivp=detest('2OD33')
    myivp=ivp#load initial parameters from problem
    t,u = rk44(myivp)#approximate soluton of problem  
    u33=np.array([u[0],u[r1], u[r2], u[r3],u[r4], u[r5]])

    ivp=detest('2OD34')
    myivp=ivp#load initial parameters from problem
    t,u = rk44(myivp)#approximate soluton of problem    
    u34=np.array([u[0],u[r1], u[r2], u[r3],u[r4], u[r5]])
    
    ivp=detest('2OD44')
    myivp=ivp#load initial parameters from problem
    t,u = rk44(myivp)#approximate soluton of problem   
   
    u44=np.array([u[0],u[r1], u[r2], u[r3],u[r4], u[r5]])


    

    x11=np.array([u11[0][0],u11[1][0],u11[2][0],u11[3][0],u11[4][0],u11[5][0], u11[0][1],u11[1][1],u11[2][1],u11[3][1],u11[4][1],u11[5][1]])#solutions with with the first and second parameter changed by an amount dq 
    
    x12=np.array([u12[0][0],u12[1][0],u12[2][0],u12[3][0],u12[4][0],u12[5][0],u12[0][1],u12[1][1],u12[2][1],u12[3][1],u12[4][1],u12[5][1]])#solutions with with the first and third parameter changed by an amount dq 
    x13=np.array([u13[0][0],u13[1][0],u13[2][0],u13[3][0],u13[4][0],u13[5][0], u13[0][1],u13[1][1],u13[2][1],u13[3][1],u13[4][1],u13[5][1]])#solutions with with the second parameter changed by an amount 2dq
    
    x14=np.array([u14[0][0],u14[1][0],u14[2][0],u14[3][0],u14[4][0],u14[5][0], u14[0][1],u14[1][1],u14[2][1],u14[3][1],u14[4][1],u14[5][1]])#solutions with with the second and third parameter changed by an amount dq
    x22=np.array([u22[0][0],u22[1][0],u22[2][0],u22[3][0],u22[4][0],u22[5][0], u22[0][1],u22[1][1],u22[2][1],u22[3][1],u22[4][1],u22[5][1]])#solutions with with the third parameter changed by an amount 2dq
    
    x23=np.array([u23[0][0],u23[1][0],u23[2][0],u23[3][0],u23[4][0],u24[5][0], u23[0][1],u23[1][1],u23[2][1],u23[3][1],u23[4][1],u24[5][1]])#solutions with with the first parameter changed by an amount 2dq

    x24=np.array([u24[0][0],u24[1][0],u24[2][0],u24[3][0],u24[4][0],u24[5][0],u24[0][1],u24[1][1],u24[2][1],u24[3][1],u24[4][1],u24[5][1]])#solutions with with the first and second parameter changed by an amount dq 
    
    x33=np.array([u33[0][0],u33[1][0],u33[2][0],u33[3][0],u33[4][0],u33[5][0], u33[0][1],u33[1][1],u33[2][1],u33[3][1],u33[4][1],u33[5][1]])#solutions with with the first and third parameter changed by an amount dq 
    x34=np.array([u34[0][0],u34[1][0],u34[2][0],u34[3][0],u34[4][0],u34[5][0], u34[0][1],u34[1][1],u34[2][1],u34[3][1],u34[4][1],u34[5][1] ])#

    x44=np.array([u44[0][0],u44[1][0],u44[2][0],u44[3][0],u44[4][0],u44[5][0],u44[0][1],u44[1][1],u44[2][1],u44[3][1],u44[4][1],u44[5][1]])#solutions with with the second parameter changed by an amount 2dq
    ...
    v11=np.array([((x11[0]-(2*x1[0]-x0[0]))/((dq)**2)), ((x11[1]-(2*x1[1]-x0[1]))/((dq)**2)),((x11[2]-(2*x1[2]-x0[2]))/((dq)**2)),
                  ...
                  ((x11[9]-(2*x1[9]-x0[9]))/((dq)**2)),((x11[10]-(2*x1[10]-x0[10]))/((dq)**2)), ((x11[11]-(2*x1[11]-x0[11]))/((dq)**2))])#second derivative with 1 parameter of function
    ...
    v12=np.array([((x12[0]-x1[0]-x2[0]+x0[0])/((dq)**2)), ((x12[1]-x1[1]-x2[1]+x0[1])/((dq)**2)),((x12[2]-x1[2]-x2[2]+x0[2])/((dq)**2)),
                  ...
                  ((x12[8]-x1[8]-x2[8]+x0[8])/((dq)**2)),((x12[9]-x1[9]-x2[9]+x0[9])/((dq)**2)),((x12[10]-x1[10]-x2[10]+x0[10])/((dq)**2)),
                  ((x12[11]-x1[11]-x2[11]+x0[11])/((dq)**2))   ])#derivative with 1 and 2 parameter of function 
    ...
    v13=np.array([((x13[0]-x1[0]-x3[0]+x0[0])/((dq)**2)), ((x13[1]-x1[1]-x3[1]+x0[1])/((dq)**2)),((x13[2]-x1[2]-x3[2]+x0[2])/((dq)**2)),
            ...
            ((x13[6]-x1[6]-x3[6]+x0[6])/((dq)**2)),((x13[7]-x1[7]-x3[7]+x0[7])/((dq)**2)),
                  ((x13[8]-x1[8]-x3[8]+x0[8])/((dq)**2)),((x13[9]-x1[9]-x3[9]+x0[9])/((dq)**2)),((x13[10]-x1[10]-x3[10]+x0[10])/((dq)**2)),
                 ((x13[11]-x1[11]-x3[11]+x0[11])/((dq)**2))])#   derivative with 1 and 3 parameter of function
    ...
    v22=np.array([((x22[0]-(2*x2[0]-x0[0]))/((dq)**2)), ((x22[1]-(2*x2[1]-x0[1]))/((dq)**2)),((x22[2]-(2*x2[2]-x0[2]))/((dq)**2)),
                 ...
                 ((x22[6]-(2*x2[6]-x0[6]))/((dq)**2)),((x22[7]-(2*x2[7]-x0[7]))/((dq)**2)),
                  ((x22[8]-(2*x2[8]-x0[8]))/((dq)**2)),((x22[9]-(2*x2[9]-x0[9]))/((dq)**2)),((x22[10]-(2*x2[10]-x0[10]))/((dq)**2)), ((x22[11]-(2*x2[11]-x0[11]))/((dq)**2))   ])#second derivative with 2 parameter of function
    ...
    v23=np.array([((x23[0]-x3[0]-x2[0]+x0[0])/((dq)**2)), ((x23[1]-x3[1]-x2[1]+x0[1])/((dq)**2)),((x23[2]-x3[2]-x2[2]+x0[2])/((dq)**2)),
                 ...
                 ((x23[6]-x2[6]-x3[6]+x0[6])/((dq)**2)),((x23[7]-x2[7]-x3[7]+x0[7])/((dq)**2)), ((x23[8]-x2[8]-x3[8]+x0[8])/((dq)**2)),
                  ((x23[9]-x2[9]-x3[9]+x0[9])/((dq)**2)),((x23[10]-x2[10]-x3[10]+x0[10])/((dq)**2)),((x23[11]-x2[11]-x3[11]+x0[11])/((dq)**2))  ])#derivative with 2 and 3 parameter of function
    ...
    v33=np.array([((x33[0]-(2*x3[0]-x0[0]))/((dq)**2)), ((x33[1]-(2*x3[1]-x0[1]))/((dq)**2)),((x33[2]-(2*x3[2]-x0[2]))/((dq)**2)),
                 ...
                 ((x33[6]-(2*x3[6]-x0[6]))/((dq)**2)),((x33[7]-(2*x3[7]-x0[7]))/((dq)**2)), ((x33[8]-(2*x3[8]-x0[8]))/((dq)**2)),
                  ((x33[9]-(2*x3[9]-x0[9]))/((dq)**2)),((x33[10]-(2*x3[10]-x0[10]))/((dq)**2)), ((x33[11]-(2*x3[11]-x0[11]))/((dq)**2))  ])#second derivative with 3 parameter of function
    ...
    v14=np.array([((x14[0]-x1[0]-x4[0]+x0[0])/((dq)**2)), ((x14[1]-x1[1]-x4[1]+x0[1])/((dq)**2)),((x14[2]-x1[2]-x4[2]+x0[2])/((dq)**2)),
                 ...
                 ((x14[6]-x1[6]-x4[6]+x0[6])/((dq)**2)),((x14[7]-x1[7]-x4[7]+x0[7])/((dq)**2)),
                  ((x14[8]-x1[8]-x4[8]+x0[8])/((dq)**2)),((x14[9]-x1[9]-x4[9]+x0[9])/((dq)**2)),
                  ((x14[10]-x1[10]-x4[10]+x0[10])/((dq)**2)),((x14[11]-x1[11]-x4[11]+x0[11])/((dq)**2)) ])#derivative with 1 and 3 parameter of function
    v24=np.array([((x24[0]-x2[0]-x4[0]+x0[0])/((dq)**2)), ((x24[1]-x2[1]-x4[1]+x0[1])/((dq)**2)),((x24[2]-x2[2]-x4[2]+x0[2])/((dq)**2)),
                 ...
                 ((x24[6]-x4[6]-x2[6]+x0[6])/((dq)**2)),((x24[7]-x4[7]-x2[7]+x0[7])/((dq)**2)),
                  ((x24[8]-x4[8]-x2[8]+x0[8])/((dq)**2)),((x24[9]-x4[9]-x2[9]+x0[9])/((dq)**2)),
                 ((x24[10]-x4[10]-x2[10]+x0[10])/((dq)**2)),((x24[11]-x4[11]-x2[11]+x0[11])/((dq)**2)) ])       
    #second derivative with 2 parameter of function
    ...
    v34=np.array([((x34[0]-x3[0]-x4[0]+x0[0])/((dq)**2)), ((x34[1]-x3[1]-x4[1]+x0[1])/((dq)**2)),((x34[2]-x3[2]-x4[2]+x0[2])/((dq)**2)),
                  ...
                  ((x34[9]-x3[9]-x4[9]+x0[9])/((dq)**2)),((x34[10]-x3[10]-x4[10]+x0[10])/((dq)**2)), ((x34[11]-x3[11]-x4[11]+x0[11])/((dq)**2))  ])#derivative with 2 and 3 parameter of function
    ...
    v44=np.array([((x44[0]-(2*x4[0]-x0[0]))/((dq)**2)), ((x44[1]-(2*x4[1]-x0[1]))/((dq)**2)),((x44[2]-(2*x4[2]-x0[2]))/((dq)**2)),
                 ...
                 ((x44[6]-(2*x4[6]-x0[6]))/((dq)**2)),((x44[7]-(2*x4[7]-x0[7]))/((dq)**2)), ((x44[8]-(2*x4[8]-x0[8]))/((dq)**2)),
                  ((x44[9]-(2*x4[9]-x0[9]))/((dq)**2)),((x44[10]-(2*x4[10]-x0[10]))/((dq)**2)), ((x44[11]-(2*x4[11]-x0[11]))/((dq)**2)) ])


    derv11=delta1*sum(2*(v1[0:6])**2-2*(xfact[0:6]-x0[0:6])*v11[0:6])+delta2*sum(2*(v1[6:])**2-2*(xfact[6:]-x0[6:])*v11[6:])
    derv12=delta1*sum(2*(v1[0:6])*v2[0:6]-2*(xfact[0:6]-x0[0:6])*v12[0:6])+delta2*sum(2*(v1[6:])*v2[6:]-2*(xfact[6:]-x0[6:])*v12[6:])
    derv13=delta1*sum(2*(v1[0:6])*v3[0:6]-2*(xfact[0:6]-x0[0:6])*v13[0:6])+delta2*sum(2*(v1[6:])*v3[6:]-2*(xfact[6:]-x0[6:])*v13[6:])
    derv14=delta1*sum(2*(v1[0:6])*v4[0:6]-2*(xfact[0:6]-x0[0:6])*v14[0:6])+delta2*sum(2*(v1[6:])*v4[6:]-2*(xfact[6:]-x0[6:])*v14[6:])

    derv22=delta1*sum(2*(v2[0:6])**2-2*(xfact[0:6]-x0[0:6])*v22[0:6])+delta2*sum(2*(v2[6:])**2-2*(xfact[6:]-x0[6:])*v22[6:])
    derv23=delta1*sum(2*(v2[0:6])*v3[0:6]-2*(xfact[0:6]-x0[0:6])*v23[0:6])+delta2*sum(2*(v2[6:])*v3[6:]-2*(xfact[6:]-x0[6:])*v23[6:])
    derv24=delta1*sum(2*(v2[0:6])*v4[0:6]-2*(xfact[0:6]-x0[0:6])*v24[0:6])+delta2*sum(2*(v2[6:])*v4[6:]-2*(xfact[6:]-x0[6:])*v24[6:])

    derv33=delta1*sum(2*(v3[0:6])**2-2*(xfact[0:6]-x0[0:6])*v33[0:6])+delta2*sum(2*(v3[6:])**2-2*(xfact[6:]-x0[6:])*v33[6:])
    derv34=delta1*sum(2*(v3[0:6])*v4[0:6]-2*(xfact[0:6]-x0[0:6])*v34[0:6])+delta2*sum(2*(v3[6:])*v4[6:]-2*(xfact[6:]-x0[6:])*v34[6:])

    derv44=delta1*sum(2*(v4[0:6])**2-2*(xfact[0:6]-x0[0:6])*v44[0:6])+delta2*sum(2*(v4[6:])**2-2*(xfact[6:]-x0[6:])*v44[6:])
    ...
    u6=np.array([u[0],u[r1],u[r2],u[r3],u[r4],u[r5]])#approximate soluton in moment of time 1,2,3
    thlist=([t[0],t[r1],t[r2],t[r3],t[r4],t[r5]]) 
    x0=np.array([u6[0][0],u6[1][0],u6[2][0],u6[3][0],u6[4][0],u6[5][0],u6[0][1],u6[1][1],u6[2][1],u6[3][1],u6[4][1],u6[5][1]])
    x01list1=([u6[0][0],u6[1][0],u6[2][0],u6[3][0],u6[4][0],u6[5][0]])#for plot of 1 region
    x01list2=([u6[0][1],u6[1][1],u6[2][1],u6[3][1],u6[4][1],u6[5][1]])#for plot of 2 region 
    fig1.append(plt.plot(thlist,x01list1,"g-",lw=0.5))#for plot of 1 region
    fig1.append(plt.plot(thlist,x01list2,"y-",lw=0.5))#for plot of 2 region

    func1=delta1*sum((xfact[0:6]-x0[0:6])**2)+delta2*sum((xfact[6:]-x0[6:])**2) #Find value of function with new parameters    
    ...
    if (funclist[i-1]>funclist[i]):
                ...
                x2=np.array([u8[0][0],u8[1][0],u8[2][0],u8[3][0],u8[4][0],u8[5][0],u8[0][1],u8[1][1],u8[2][1],u8[3][1],u8[4][1],u8[5][1]])#solutions with with the second parameter changed by an amount dq
                x3=np.array([u9[0][0],u9[1][0],u9[2][0],u9[3][0],u9[4][0],u9[5][0], u9[0][1],u9[1][1],u9[2][1],u9[3][1],u9[4][1],u9[5][1] ])##solutions with with the third parameter changed by an amount dq
                x4=np.array([u40[0][0],u40[1][0],u40[2][0],u40[3][0],u40[4][0],u40[5][0],u40[0][1],u40[1][1],u40[2][1],u40[3][1],u40[4][1],u40[5][1]])
                         
                print('value for changing the Hessian matrix in 0 step:')
                print(mu0)
                                  
                v1=np.array([((x1[0]-x0[0])/dq), ((x1[1]-x0[1])/dq),((x1[2]-x0[2])/dq), ((x1[3]-x0[3])/dq),((x1[4]-x0[4])/dq), ((x1[5]-x0[5])/dq),
                             ((x1[6]-x0[6])/dq), ((x1[7]-x0[7])/dq),((x1[8]-x0[8])/dq), ((x1[9]-x0[9])/dq), ((x1[10]-x0[10])/dq), ((x1[11]-x0[11])/dq) ])#derivative with the first parameter
                v2=np.array([((x2[0]-x0[0])/dq), ((x2[1]-x0[1])/dq),((x2[2]-x0[2])/dq), ((x2[3]-x0[3])/dq),((x2[4]-x0[4])/dq),
                             ((x2[5]-x0[5])/dq),((x2[6]-x0[6])/dq), ((x2[7]-x0[7])/dq),((x2[8]-x0[8])/dq), ((x2[9]-x0[9])/dq),((x2[10]-x0[10])/dq),
                             ((x2[11]-x0[11])/dq) ])#derivative with the second parameter
                v3=np.array([((x3[0]-x0[0])/dq), ((x3[1]-x0[1])/dq),((x3[2]-x0[2])/dq), ((x3[3]-x0[3])/dq),((x3[4]-x0[4])/dq),
                             ((x3[5]-x0[5])/dq),((x3[6]-x0[6])/dq), ((x3[7]-x0[7])/dq),((x3[8]-x0[8])/dq), ((x3[9]-x0[9])/dq),((x3[10]-x0[10])/dq),
                             ((x3[11]-x0[11])/dq) ])#derivative with the third parameter
                v4= np.array([((x4[0]-x0[0])/dq), ((x4[1]-x0[1])/dq),((x4[2]-x0[2])/dq), ((x4[3]-x0[3])/dq),((x4[4]-x0[4])/dq),
                              ((x4[5]-x0[5])/dq),((x4[6]-x0[6])/dq), ((x4[7]-x0[7])/dq),((x4[8]-x0[8])/dq), ((x4[9]-x0[9])/dq),((x4[10]-x0[10])/dq),
                              ((x4[11]-x0[11])/dq)])
...
plt.xlabel('t')
plt.ylabel('u')
plt.legend(['initial value 1','u1(t)', 'initial value 2','u2(t)' ], loc = 'lower left')              
plt.grid(fig1)
plt.show(fig1)
...
#plt.xlabel('t')
#plt.ylabel('u')
#plt.legend(['initial value 2','u2(t)' ], loc = 'lower left')              
#plt.grid(fig2)
#plt.show(fig2)  
